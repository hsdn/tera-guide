...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3109-2000-1416-0": [
			...
			{ type: "text", sub_type: "message", message: "In | Pizza", message_RU: "К нему | Пицца", delay: 2625 },
		...
		"s-3109-2000-1417-0": [
			...
			{ type: "text", sub_type: "message", message: "Out | Pizza", message_RU: "От него | Пицца", delay: 2625 },
