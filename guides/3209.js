...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"h-3209-2000-20": [{ type: "text", sub_type: "message", message: "20%", message_RU: "." }],
		"h-3209-2000-50": [{ type: "text", sub_type: "message", message: "50%", message_RU: "." }],
		// 
		"s-3209-2000-403-0": [
			{ type: "text", sub_type: "message", message: "Back Slam", message_RU: ".", delay: 2500 },
			{ type: "spawn", func: "circle", args: [false, 553, 157, 400, 8, 350, 0, 2500], delay: 2500 }, //300
			{ type: "spawn", func: "circle", args: [false, 553, 203, 400, 8, 350, 0, 2500], delay: 2500 }
		],
		"s-3209-2000-405-0": [
			{ type: "text", sub_type: "message", message: "Front Sweep | Back Slam", message_RU: "." },
		...
		"s-3209-2000-406-0": [{ type: "text", sub_type: "message", message: "Back Stun", message_RU: ".", delay: 1000 }],
		"s-3209-2000-409-0": [
			{ type: "text", sub_type: "message", message: "Back Slam", message_RU: ".", delay: 3000 },
		...
		"s-3209-2000-417-0": [
		{ type: "text", sub_type: "message", message: "In-Out | Pizza", message_RU: "." },
		...
		// Dig
		"s-3209-2000-511-0": [
			{ type: "text", sub_type: "message", message: "Dodge", message_RU: "." },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 18, 200, 0, 2500] }
		],
		"s-3209-2000-602-0": [
			{ type: "text", sub_type: "message", message: "Get Out", message_RU: "." },
            { type: "func", func: cage_event }
		],
        "s-3209-2000-604-0": [
			{ type: "despawn_all", tag: "pre-cage" },
			{ type: "text", sub_type: "message", message: "Cage", message_RU: "." },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 405, 0, 15000], tag: "cage" }
		],
		"s-3209-2000-605-0": [
			{ type: "text", sub_type: "message", message: "Pizza | Out-in", message_RU: ".", delay: 2000 },
			{ type: "text", sub_type: "message", message: "Pizza | Out-in", message_RU: ".", delay: 5000 },
		...
		// Waves
		"s-3209-2000-616-0": [{ type: "text", sub_type: "message", message: "Inward Wave (Gather)", message_RU: "." }],
		"ae-0-0-32092005": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "."}],
		"s-3209-2000-617-0": [
			{ type: "text", sub_type: "message", message: "Front | Back Waves", message_RU: "." },
			{ type: "text", sub_type: "message", message: "Front | Back Waves", message_RU: ".", delay: 3000 },
		...
		// Dakuryon
		"s-3209-2750-301-0": [
			{ type: "text", sub_type: "message", message: "Dakuryon", message_RU: "." },
